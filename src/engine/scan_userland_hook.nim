...
char *rk_hook_find_hijack_func() {
  ...
  char *symb_name;
  char *COMMON_FUNCTIONS[] = {"rename", "renameat", "stat", "stat64", "fstat", "fstat64", "lstat", "lstat64", "__lxstat", "__lxstat64", "__fxstat", "__fxstat64", "__xstat", "__xstat64", "access", "unlink", "strstr" , NULL};
  int i = 0;
