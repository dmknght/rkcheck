...
{.pragma: impclamavHdr, header: "/tmp/clamav/libclamav/clamav.h".}
{.experimental: "codeReordering".}
# {.passC: "-I/tmp/clamav/libclamav".}
{.passL: "-lclamav".}
# type
  # cl_error_t* = enum
  #   # /* libclamav specific */
  ...
  #   CL_ELAST_ERROR
  # cl_engine_field* = object
  #   CL_ENGINE_MAX_SCANSIZE*: uint64
  #   CL_ENGINE_MAX_FILESIZE*: uint64
  #   CL_ENGINE_MAX_RECURSION*: uint32
  #   CL_ENGINE_MAX_FILES*: uint32
  #   CL_ENGINE_MIN_CC_COUNT*: uint32
  #   CL_ENGINE_MIN_SSN_COUNT*: uint32
  #   CL_ENGINE_PUA_CATEGORIES*: string
  #   CL_ENGINE_DB_OPTIONS*: uint32
  #   CL_ENGINE_DB_VERSION*: uint32
  #   CL_ENGINE_DB_TIME*: Time
  #   CL_ENGINE_AC_ONLY*: uint32
  #   CL_ENGINE_AC_MINDEPTH*: uint32
  #   CL_ENGINE_AC_MAXDEPTH*: uint32
  #   CL_ENGINE_TMPDIR*: string
  #   CL_ENGINE_KEEPTMP*: uint32
  #   CL_ENGINE_BYTECODE_SECURITY*: uint32
  #   CL_ENGINE_BYTECODE_TIMEOUT*: uint32
  #   CL_ENGINE_BYTECODE_MODE*: uint32
  #   CL_ENGINE_MAX_EMBEDDEDPE*: uint64
  #   CL_ENGINE_MAX_HTMLNORMALIZE*: uint64
  #   CL_ENGINE_MAX_HTMLNOTAGS*: uint64
  #   CL_ENGINE_MAX_SCRIPTNORMALIZE*: uint64
  #   CL_ENGINE_MAX_ZIPTYPERCG*: uint64
  #   CL_ENGINE_FORCETODISK*: uint32
  #   CL_ENGINE_DISABLE_CACHE*: uint32
  #   CL_ENGINE_DISABLE_PE_STATS*: uint32
  #   CL_ENGINE_STATS_TIMEOUT*: uint32
  #   CL_ENGINE_MAX_PARTITIONS*: uint32
  #   CL_ENGINE_MAX_ICONSPE*: uint32
  #   CL_ENGINE_MAX_RECHWP3*: uint32
  #   CL_ENGINE_MAX_SCANTIME*: uint32
  #   CL_ENGINE_PCRE_MATCH_LIMIT*: uint64
  #   CL_ENGINE_PCRE_RECMATCH_LIMIT*: uint64
  #   CL_ENGINE_PCRE_MAX_FILESIZE*: uint64
  #   CL_ENGINE_DISABLE_PE_CERTS*: uint32
  #   CL_ENGINE_PE_DUMPCERTS*: uint32
  # cl_msg* = enum
