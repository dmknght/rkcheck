...
rule Hacktool_LoginBrute {
  meta:
    ...
    target = "File, memory"
  strings:
    $1 = { 70 40 63 6B 33 74 66 33 6E 63 33 } // "p@ck3tf3nc3"
    $2 = { 37 75 6A 4D 6B 6F 30 } // "7ujMko0"
    $3 = { 73 34 62 65 42 73 45 51 68 64 } // "s4beBsEQhd"
    $4 = { 52 4F 4F 54 35 30 30 } // "ROOT500"
    $5 = { 4C 53 69 75 59 37 70 4F 6D 5A 47 32 73 } // "LSiuY7pOmZG2s"
    $6 = { 67 77 65 76 72 6B 37 66 40 71 77 53 58 24 66 64 } // "gwevrk7f@qwSX$fd"
    $7 = { 68 75 69 67 75 33 30 39 } // "huigu309"
    $8 = { 74 61 5A 7A 40 32 33 34 39 35 38 35 39 } // "taZz@23495859"
    $9 = { 68 64 69 70 63 25 4E 6F } // "hdipc%No"
    $10 = { 44 46 68 78 64 68 64 66 } // "DFhxdhdf"
    $11 = { 58 44 7A 64 66 78 7A 66 } // "XDzdfxzf"
    $12 = { 55 59 79 75 79 69 6F 79 } // "UYyuyioy"
    $13 = { 4A 75 59 66 6F 75 79 66 38 37 } // "JuYfouyf87"
    $14 = { 4E 69 47 47 65 52 36 39 78 64 } // "NiGGeR69xd"
    $15 = { 4E 69 47 47 65 52 44 30 6E 6B 73 36 39 } // "NiGGeRD0nks69"
    $16 = { 54 59 32 67 44 36 4D 5A 76 4B 63 37 4B 55 36 72 } // "TY2gD6MZvKc7KU6r"
    $17 = { 41 30 32 33 55 55 34 55 32 34 55 49 55 } // "A023UU4U24UIU"
    $18 = { 73 63 61 6E 4A 6F 73 68 6F } // "scanJosho"
    $19 = { 53 32 66 47 71 4E 46 73 } // "S2fGqNFs"
    $20 = { 37 75 6A 4D 6B 6F 30 61 64 6D 69 6E } // "7ujMko0admin"
  condition:
    any of them
}
