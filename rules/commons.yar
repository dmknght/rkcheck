...
rule ML_Gen1 {
  strings:
		$s2 = "AWAVAUATUHSHHHHu" fullword
		$s3 = "3zOWSvAY2dn9rKZZOfkJ" fullword
		$s5 = "FVGWFVGWFVGWFVGWv" fullword
		...
		$s16 = "ServiceVersionInfo" fullword
		$s17 = "fillFromfdWithContext" fullword
		$s18 = "1XZfAWAVAUATIUHSHH8HD" fullword
		$s22 = "AWHcAVL4AUAATUHSHH" fullword
		$s23 = "E1bqZvNzhdcQOPpq1" fullword
		$s24 = "dis4blens4sel1nuxhayettgdr64545" fullword
		$s25 = "JNIEnv9NewObjectEP7" fullword
		$s26 = "PDZ83RXolqXJmVQcB" fullword
		$s28 = "248d1a2560100669" fullword
		$s30 = "AWAVIAUATIUSHHHH" fullword
		$s31 = "NNkOOFPGPHPIIPJJPKK" fullword
		$s32 = "RfAWAVAUIATUSHxdH" fullword
		$s34 = "bba1a886b2fcfd1666a9d8c72cda021a" fullword
		$s37 = "GtvRsdC7YqIEXKfsICVsKakP" fullword
		$s52 = "fAWHHAVAUATUSHHXR" fullword
		$s53 = "oPrcpy6killGG18read" fullword
		$s57 = "CGJKMNPRSTUcfgjkmnoprstuvy" fullword
		$s59 = "UHAWAVAUATSPLEIIIIYH" fullword
		$s60 = "HEHUHPPHEHTHHEHPhHEH" fullword
		$s61 = "AWIAVAUIATMUHSHH" fullword
		$s65 = "to3ms0aQROMFGSAFDbBKA" fullword
		$s66 = "AbcDgHIjklMnoTPqrsuzVYEFWX" fullword
		$s67 = "fmBvM4NKD2lcLvjhN5GjF" fullword
		$s68 = "AWMMAVAUATIUSH8L" fullword
		$s69 = "1KKB2F2KKJ2N2KKR2V2KKZ2" fullword
		$s70 = "gomerultiplicDpnor" fullword
		$s71 = "WPLyo7nzaL6bQYD0wf" fullword
		$s74 = "4Hx8LLHEH8kZHMLLL" fullword
		$s75 = "31337890Saihyousen" fullword
		$s76 = "AWMAVI1AUIHATA1USLH" fullword
		$s77 = "curGlyphIsAControlGlyph" fullword
		$s78 = "jRqHl4oapnycPKw2vaHxxKLs1t" fullword
		$s80 = "1f994a2453c41c7c5ce2f4dc7591b576" fullword
		$s81 = "7777r7777999995dddv0" fullword
		$s84 = "Prcpy6killGG18readm" fullword
		$s123 = "6M6O6S6Y6a6k6m666666666666" fullword
		$s126 = "QLufovYZMvbq01FN" fullword
		$s127 = "Cdh5GZtVWYhl2cuFGdz9mLsNWdAI" fullword
		$s543 = "tp0isomairispipesispmmgrj" fullword
		$s546 = "Imyhostna111E1E1" fullword
		$s573 = "linenoiseHistoryAdd" fullword
		$s576 = "HEHEUHEHHEHEHHpH" fullword
		$s582 = "L1I3SH1HVI1HnL1LfAD" fullword
		$s587 = "AWIAVMAUILATILUHLSHLH" fullword
		$s591 = "HH6Ht1HSUUUUUUUH9w4HHHt" fullword
		$s593 = "AWAVAUATMUHSLH8H" fullword
		$s628 = "II46IjNZztN9bmbxUD8dt8g" fullword
		$s629 = "ZN5boost4asio6detail21resolver" fullword
		$s630 = "13ByteRunPolicyENS" fullword
		$s675 = "AWIAVAUIATUHSLM4" fullword
  condition:
